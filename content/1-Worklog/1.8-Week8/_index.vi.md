...
| --- | --- | --- | --- | --- |
| 2 | - Học tập trực tiếp tại văn phòng. <br>&emsp; + Trao đổi với nhóm về kế hoạch công việc trong ngày trước khi bắt đầu. <br> - Nâng cấp logic phát hiện bất thường: <br>&emsp; + Viết hàm đọc dữ liệu chi phí các ngày lịch sử từ S3 và tính chi phí trung bình. <br>&emsp; + Bổ sung logic phát hiện tăng đột biến (chi phí > trung bình × hệ số). <br>&emsp; + Bổ sung 2 biến cấu hình `SPIKE_MULTIPLIER` và `HISTORY_DAYS`. <br>&emsp; + Cuối ngày tổng hợp và chia sẻ kết quả với nhóm. | 29/06/2026 | 29/06/2026 | - Boto3 S3 Client: <br> https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/s3.html |
| 3 | - Phân loại mức độ cảnh báo và hoàn thiện nội dung SNS: <br>&emsp; + Trao đổi với nhóm về kế hoạch công việc trong ngày trước khi bắt đầu. <br>&emsp; + Xây dựng logic phân loại INFO / WARNING / CRITICAL theo ngưỡng và mức độ đột biến. <br>&emsp; + Cập nhật nội dung email cảnh báo: thêm mức độ, lý do cảnh báo, phần trăm tăng và trung bình lịch sử. <br>&emsp; + Chuẩn hóa định dạng hiển thị số tiền ($X.XX). <br>&emsp; + Cuối ngày tổng hợp và chia sẻ kết quả với nhóm. | 30/06/2026 | 30/06/2026 |  |
| 4 | - Cập nhật Terraform, kiểm thử 3 mức và xử lý lỗi (DLQ): <br>&emsp; + Trao đổi với nhóm về kế hoạch công việc trong ngày trước khi bắt đầu. <br>&emsp; + Bổ sung biến `spike_multiplier`, `history_days` và triển khai code Analyzer nâng cấp. <br>&emsp; + Viết script sinh dữ liệu mô phỏng, kiểm thử 3 kịch bản INFO / WARNING / CRITICAL. <br>&emsp; + Kiểm thử DLQ: gửi message lỗi, xác minh message tự chuyển vào Dead Letter Queue. <br>&emsp; + Cuối ngày tổng hợp và chia sẻ kết quả với nhóm. | 01/07/2026 | 01/07/2026 | - Amazon SQS Dead-Letter Queues: <br> https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-dead-letter-queues.html <br> - Terraform aws_lambda_function: <br> https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lambda_function |
| 5 | - Kiểm thử end-to-end toàn hệ thống: <br>&emsp; + Trao đổi với nhóm về kế hoạch công việc trong ngày trước khi bắt đầu. <br>&emsp; + Chuẩn bị dữ liệu chi phí mô phỏng (lịch sử + ngày test) trong S3 cho các mức WARNING và CRITICAL. <br>&emsp; + Chỉ kích hoạt từ Lambda Collector, để hệ thống tự động chạy qua SQS tới Analyzer mà không can thiệp thủ công. <br>&emsp; + Theo dõi cả chuỗi tự chạy: Collector, S3, SQS, Analyzer, SNS. <br>&emsp; + Cuối ngày tổng hợp và chia sẻ tiến độ với nhóm. | 02/07/2026 | 02/07/2026 | - Testing Lambda functions: <br> https://docs.aws.amazon.com/lambda/latest/dg/testing-functions.html <br> - Using Lambda with SQS: <br> https://docs.aws.amazon.com/lambda/latest/dg/with-sqs.html |
| 6 | - Xác minh kết quả và tinh chỉnh: <br>&emsp; + Trao đổi với nhóm về kế hoạch công việc trong ngày trước khi bắt đầu. <br>&emsp; + Xác nhận email cảnh báo WARNING và CRITICAL nhận đúng, định dạng số tiền gọn ($X.XX). <br>&emsp; + Kiểm tra CloudWatch Logs xác nhận phân loại đúng mức. <br>&emsp; + Tinh chỉnh ngưỡng về giá trị thực tế và dọn dẹp dữ liệu test. <br>&emsp; + Cuối ngày tổng hợp và chia sẻ kết quả với nhóm. | 03/07/2026 | 03/07/2026 | |
